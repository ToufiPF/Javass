...
class MctsPlayerTest {
    ...
    private static Map<PlayerId, Player> createMapMctsPlayers(int seed,
            int iterations) {
    ...
    void test4Mcts() {
        ...
        players.put(PlayerId.PLAYER_1, new PrintingPlayer(
                new MctsPlayer(PlayerId.PLAYER_1, seed, 100_000)));
        players.put(PlayerId.PLAYER_2,
                new MctsPlayer(PlayerId.PLAYER_2, seed, 1000));
        players.put(PlayerId.PLAYER_3,
                new MctsPlayer(PlayerId.PLAYER_3, seed, 100_000));
        players.put(PlayerId.PLAYER_4,
                new MctsPlayer(PlayerId.PLAYER_4, seed, 1000));
    ...
    void testParagraphe1_3() {
        TurnState state = TurnState.initial(Card.Color.SPADE, Score.INITIAL,
                PlayerId.PLAYER_1);
        state = state
                .withNewCardPlayed(Card.of(Card.Color.SPADE, Card.Rank.JACK));
        ...
        assertEquals(Card.of(Card.Color.SPADE, Card.Rank.EIGHT),
