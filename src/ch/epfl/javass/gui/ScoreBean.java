...
public final class ScoreBean {
     ...
     * @return (ReadOnlyIntegerProperty) la propriété en lecture seule contenant
     *         les points de la partie de l'équipe team
     * @throws IllegalArgumentException
     *             lorsque team n'est pas une TeamId valide
     */
     ...
     *            partie
     * @param newGamePoints
     *            (int) les nouveaux points de la partie de l'équipe team
     * @throws IllegalArgumentException
     *             lorsque team n'est pas une TeamId valide
     */
     ...
     *            (int) les nouveaux points totaux de l'équipe team
     * @throws IllegalArgumentException
     *             lorsque team n'est pas une TeamId valide
     */
     ...
     * @param newTurnPoints
     *            (int) les nouveaux points du tour de l'équipe team
     * @throws IllegalArgumentException
     *             lorsque team n'est pas une TeamId valide
     */
     ...
     * @return (ReadOnlyIntegerProperty) la propriété en lecture seule contenant
     *         les points totaux de l'équipe team
     * @throws IllegalArgumentException
     *             lorsque team n'est pas une TeamId valide
     */
    ...
    public ReadOnlyIntegerProperty turnPointsProperty(TeamId team)
        ...
        switch (team) {
        case TEAM_1:
            return turnPointsTeam1;
        case TEAM_2:
            return turnPointsTeam2;
        default:
            throw new IllegalArgumentException("Team non reconnue");
        }
    }
