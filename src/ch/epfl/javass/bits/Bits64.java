...
/**
 * Bits64
 * Une classe non instanciable, homologue à Bits32, contenant
 * des méthodes permettant de travailler sur des vecteurs de 64 bits
 * 
...
public final class Bits64 {
    ...
    /**
     * Extrait de bits le long composé par l'ensemble des bits
    ...
    /**
     * Permet de packer deux long en un seul
     ...
     *            
     * @return (long) un long composé de v1 occupant les s1 bits de poids faible et
     *         de v2 occupant les s2 bits suivants
     * @throws IllegalArgumentException
     *             si la somme de s1 et s2 dépasse la taille d'un long,
