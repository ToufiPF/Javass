...
/**
 * Player, l'interface chargée de représenter un joueur
 * Doit être implémentée par les differents types de joueurs
 * que l'on créera plus tard (humain, simulé...)
 * 
...
public interface Player {
     ...
     * @param state (TurnState) l'état du tour actuel
    ...
    /**
     * Informe le joueur de son Id, et de ce nom
     * ainsi que celui de ses adversaires.
     * A appeler une fois, en début de partie
    ...
    /**
     * Informe le joueur de sa nouvelle main.
     * A appeler dès que la main du joueur change
     * (en début de tour, ou après avoir joué une carte)
     * @param newHand
     */
    ...
    /**
     * Informe le joueur du changement de couleur des atouts.
     * A appeler quand l'atout est changé
    ...
    /**
     * Informe le joueur de l'état du pli.
     * A appeler chaque fois que le pli change
     * (après qu'une carte soit jouée, ou après un
     * nouveau pli)
    ...
    /**
     * Informe le joueur de l'équipe gagnante
     * A appeler une seule fois, quand une équipe
     * dépasse le seuil des 1000 pts
