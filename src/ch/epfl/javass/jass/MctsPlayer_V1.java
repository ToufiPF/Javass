 ...
 */
public final class MctsPlayer_V1 implements Player {
    ...
    private static class Node{
        ...
        private final MctsPlayer_V1 mRootMctsPlayer;
        ...
        private Node(TurnState turnState, CardSet nonExistingChildren, Node parent, MctsPlayer_V1 rootPlayer) {
            mState = turnState;
        ...
        public static Node rootNode(TurnState state, CardSet nonExistingChildren, MctsPlayer_V1 rootPlayer) {
    ...
    public MctsPlayer_V1(PlayerId ownId, long rngSeed, int iterations) {
