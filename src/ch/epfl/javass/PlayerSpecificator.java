...
/**
 * PlayerSpecificator Un enum contenant diverses informations concernant les
 * spécificateurs des joueurs et leurs arguments.
 *
 * @author Amaury Pierre (296498)
 * @author Aurélien Clergeot (302592)
 */
public enum PlayerSpecificator {
    HUMAN("h", 1, 2, "Humain"), SIMULATED("s", 1, 3, "Simulé"), REMOTE("r", 1,
            3, "Distant");
